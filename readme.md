# YOLOv11 Safety Helmet Detection System

## Body

YOLOv11 Safety Hat Detection System Based on Deep Learning YOLOv11, Safety Hat Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 2 classes,
Name: ['helmet', 'head'],
Dataset quantity: training set 3500, validation set 750, test set 750.
